...
- **CANON (истина проекта)**
  ...
  - [WHIEDA_DUPLICATION_SYSTEM](CANON/WHIEDA_DUPLICATION_SYSTEM.md)

- **PROCESS (как работает архитектор)**
  - [ARCHITECT_MODE](PROCESS/ARCHITECT_MODE.md)
  - [DOCUMENTATION_GOVERNANCE](PROCESS/DOCUMENTATION_GOVERNANCE.md)
  - [CHAT_HANDOFF_RULE](PROCESS/CHAT_HANDOFF_RULE.md)
  - [SYSTEM_MEMORY_RULES](PROCESS/SYSTEM_MEMORY_RULES.md)
  - [PRE_RELEASE_CHECKLIST](PROCESS/PRE_RELEASE_CHECKLIST.md)
  - [RUNTIME_PROFILE_PROD](PROCESS/RUNTIME_PROFILE_PROD.md)
...
- **SPEC / RUNBOOKS (как действовать)**
  ...
  - [MVP_V1_SCOPE](SPEC/MVP_V1_SCOPE.md)
  - [MVP_V1PLUS_SCOPE](SPEC/MVP_V1PLUS_SCOPE.md)
  - [MVP_CONVERSION_FLOW](SPEC/MVP_CONVERSION_FLOW.md)
  - [MVP_RUNTIME_BOUNDARIES](SPEC/MVP_RUNTIME_BOUNDARIES.md)
  - [MVP_ENTRY_POINTS](SPEC/MVP_ENTRY_POINTS.md)
  - [ROADMAP_V2](SPEC/ROADMAP_V2.md)
  ...
  - [WHIEDA_DUPLICATION_READY_TO_BUILD_SPEC_v1.0](SPEC/WHIEDA_DUPLICATION_READY_TO_BUILD_SPEC_v1.0.md)
