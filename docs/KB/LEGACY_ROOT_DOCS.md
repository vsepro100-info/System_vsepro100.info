...
- Root-доки имеют статус **LEGACY / READ-ONLY** и не изменяются, чтобы не создавать противоречия.

## Список legacy документов в корне
| Файл | Статус | Назначение |
| --- | --- | --- |
| ARCHITECTURE.md | LEGACY / READ-ONLY | Историческое описание архитектуры. |
| ARGUMENTS_BANK.md | LEGACY / READ-ONLY | Исторические аргументы и решения. |
| CLIENT_WEBINAR_ACTION_CONSUMERS.md | LEGACY / READ-ONLY | Архивная справка по потребителям действий. |
| CLIENT_WEBINAR_E2E_VERIFICATION.md | LEGACY / READ-ONLY | Архивные сценарии сквозной проверки. |
| CLIENT_WEBINAR_EVENTS.md | LEGACY / READ-ONLY | Архивная справка по событиям. |
